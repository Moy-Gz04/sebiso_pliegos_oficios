...
async function generarSPG() {
  ...
  try {
    ...
    const payload = {
      codigo:   datos.codigo,
      folderId: "1ygW8qdehESQH57C8mQIbenx6zqL6kKjg",
    ...
    const response = await fetch(
      "https://script.google.com/macros/s/AKfycbwU5cAgWx9jwEVfQrgWXBZCEIFFXFbcv6Y9JryYLZRIHx0MAwyBOfkBlcEXKd_qbACT/exec",
      {
        method:  "POST",
