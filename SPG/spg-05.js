...
async function generarSPG() {
  ...
  try {
    ...
    const payload = {
      codigo:   datos.codigo,
      folderId: "1aKm-YkE9higgL01Xh5kriu1nNPXvKi1X",
    ...
    const response = await fetch(
      "https://script.google.com/macros/s/AKfycbwltBc912AaMfosjKqR6FNJkVdRj95EMKvbiDyu2VH6Icmp-LVDAiheCuktfBpZcYPTHg/exec",
      {
        method:  "POST",
