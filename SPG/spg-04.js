...
async function generarSPG() {
  ...
  try {
    ...
    const payload = {
      codigo:   datos.codigo,
      folderId: "18PkZYxv_3IWBRWs4m3V_IYoDKbJnDjZk",
    ...
    const response = await fetch(
      "https://script.google.com/macros/s/AKfycbxtKKPxYTNP0hEGmZjEk0hv19bSAC8DyBUS4Q3YZWeQnT8H2t1RJ2Q8PPmZu-Mi9TVDiA/exec",
      {
        method:  "POST",
