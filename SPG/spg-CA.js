...
async function generarSPG() {
  ...
  try {
    ...
    const payload = {
      codigo:   datos.codigo,
      folderId: "1romUkZJUWv4zZEKzL1sh3JcR31YO2uUu",
    ...
    const response = await fetch(
      "https://script.google.com/macros/s/AKfycbw3pOZwVHIeuJG1wWCMrgVM5UX7wMdQ-tXf6DiUTuPVKkGku4JiwyZagXac1j61aqli/exec",
      {
        method:  "POST",
