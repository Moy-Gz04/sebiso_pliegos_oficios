...
async function generarSPG() {
  ...
  try {
    ...
    const payload = {
      codigo:   datos.codigo,
      folderId: "1xL0ZlKlOeT7xRLp4Ge_0wiyXOI0xLnnt",
    ...
    const response = await fetch(
      "https://script.google.com/macros/s/AKfycbzN5qNShWQEi8F-KM48h0BuXHUmqUmstMpqGAdX9Yxugs7vokrJO0wc29jAoRSkfsOABA/exec",
      {
        method:  "POST",
