...
async function generarSPG() {
  ...
  try {
    ...
    const payload = {
      codigo:   datos.codigo,
      folderId: "1Q3qkqCBYnaF-ciUzwOEVgmyzP09orX9N",
    ...
    const response = await fetch(
      "https://script.google.com/macros/s/AKfycbwzaPjLIh1AikTS5xKa8kf-43D8MhDjsjMcgq7wiPZJIPCMdgABecmyenJBnanJRq6A/exec",
      {
        method:  "POST",
