...
async function generarSPG() {
  ...
  try {
    ...
    const payload = {
      codigo:   datos.codigo,
      folderId: "1M3U7Hppl4jgev1L_8j5rMkPRqZRMANGE",
    ...
    const response = await fetch(
      "https://script.google.com/macros/s/AKfycbxARr1HcjxwttKKDIEjgzk-7cuMJyF0p1tUy74NzzMVMP1AcdbHy06sf0jqUt1AHHpS/exec",
      {
        method:  "POST",
