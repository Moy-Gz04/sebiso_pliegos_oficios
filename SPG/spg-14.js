...
async function generarSPG() {
  ...
  try {
    ...
    const payload = {
      codigo:   datos.codigo,
      folderId: "1AZtRgRZuA7qwvzOTc9guV21ERDRbFPiU",
    ...
    const response = await fetch(
      "https://script.google.com/macros/s/AKfycbwgUrRBUXIMjBolmdf54bVyCbTOgAREreSdGzCwfnclBLW0-r1uEBQV_lt1IME2B90uyQ/exec",
      {
        method:  "POST",
