...
async function generarSPG() {
  ...
  try {
    ...
    const payload = {
      codigo:   datos.codigo,
      folderId: "1akd7bYQTVF-VDMnrse9hRroKNWte0KKO",
    ...
    const response = await fetch(
      "https://script.google.com/macros/s/AKfycbxdW3C0K-mNXiDNpIqfzupXG4uwMdo9z5eBJmLqwE1U7rvrUXmGxBVT9v4Qnnx6JLuP/exec",
      {
        method:  "POST",
