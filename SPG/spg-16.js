...
async function generarSPG() {
  ...
  try {
    ...
    const payload = {
      codigo:   datos.codigo,
      folderId: "1d48OIkg368Uxo2yFnxyzQ3FFR9P7rLcL",
    ...
    const response = await fetch(
      "https://script.google.com/macros/s/AKfycbz2lOxxCyAkxRyoA298HqnpCb1uTLS_zRc671y1D8pDuEKvgzDvBZbqs42IFzA38Vtj/exec",
      {
        method:  "POST",
