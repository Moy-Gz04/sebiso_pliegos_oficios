...
const API_FACTURA =
    "https://script.google.com/macros/s/AKfycbxsybh5oH2TYvJ4YrBqGbo0i-dvKmR05QdR-06LVhIwPWiKl6waZzLJbrpP-3pYanE/exec";
...
async function abrirModalFactura(codigo) {
    try {
        ...
        try {
            const responseOficio = await fetch(`${API}/api/presupuestos/ultimo-oficio/9`);
