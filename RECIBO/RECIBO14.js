...
const API_FACTURA =
    "https://script.google.com/macros/s/AKfycbwIUiHaacaYOLsA0egkBvxFL4v_CxgAoy9aTDX1QNPVpIPi1JCYKQLg4S0TbnqnX_3G/exec";
...
async function abrirModalFactura(codigo) {
    try {
        ...
        try {
            const responseOficio = await fetch(`${API}/api/presupuestos/ultimo-oficio/10`);
