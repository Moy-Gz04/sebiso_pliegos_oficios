...
const API_FACTURA =
    "https://script.google.com/macros/s/AKfycbyS-K5vHB6-gZcclDwQOrxh4Va9-u2-yIHJiq7E2NnCWjsmze9jyvBylV0d-HvzC-g4/exec";
...
async function abrirModalFactura(codigo) {
    try {
        ...
        try {
            const responseOficio = await fetch(`${API}/api/presupuestos/ultimo-oficio/5`);
