...
const API_FACTURA =
    "https://script.google.com/macros/s/AKfycbygO9P0vilktSdSFA5o0V56_8U06nG9Q3L4HmvPhpgX3GD9lRpWBqUrH8yFV_CQjE1x5w/exec";
...
async function abrirModalFactura(codigo) {
    try {
        ...
        try {
            const responseOficio = await fetch(`${API}/api/presupuestos/ultimo-oficio/11`);
