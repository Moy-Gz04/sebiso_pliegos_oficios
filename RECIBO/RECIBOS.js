...
const API_FACTURA =
    "https://script.google.com/macros/s/AKfycbxUOspMtoqiITLw2mY0argm_ShwFCXGtTEJ1Q_HNMDdog7ZuzvJDAPUW6FNswuLZ6uj/exec";
...
async function abrirModalFactura(codigo) {
    try {
        ...
        try {
            const responseOficio = await fetch(`${API}/api/presupuestos/ultimo-oficio/3`);
