...
const API_FACTURA =
    "https://script.google.com/macros/s/AKfycbxIKSb02wYTiqmOGoe7EZR3qvK5P5GxArI8BsC15Ori2fsSTPEZSJzplerhwrSDGpImeA/exec";
...
async function abrirModalFactura(codigo) {
    try {
        ...
        try {
            const responseOficio = await fetch(`${API}/api/presupuestos/ultimo-oficio/2`);
