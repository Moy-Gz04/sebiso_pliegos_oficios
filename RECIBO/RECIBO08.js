...
const API_FACTURA =
    "https://script.google.com/macros/s/AKfycbzw9ZdG1TIlHdTqW2olyoXWqqGg2mNOwL6LxGFak06fJspyMiZz-9Hm_pY2LpIN_B-0/exec";
...
async function abrirModalFactura(codigo) {
    try {
        ...
        try {
            const responseOficio = await fetch(`${API}/api/presupuestos/ultimo-oficio/8`);
