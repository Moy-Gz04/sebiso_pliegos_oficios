...
const API_FACTURA =
    "https://script.google.com/macros/s/AKfycby3jAFKss1bPCcP2UWcyQf26sjTeJAOAOa5dPnmGrWQfBpTjWwBithooAzU7p1nzdTS/exec";
...
async function abrirModalFactura(codigo) {
    try {
        ...
        try {
            const responseOficio = await fetch(`${API}/api/presupuestos/ultimo-oficio/7`);
