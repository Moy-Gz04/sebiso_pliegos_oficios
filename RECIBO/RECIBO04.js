...
const API_FACTURA =
    "https://script.google.com/macros/s/AKfycbxM93_IAxLllJqcmHmZMDO5JhaZ-at8lCNXBmywNjuiFLz3WOcSJGGhvF4L3_rtAtkR0A/exec";
...
async function abrirModalFactura(codigo) {
    try {
        ...
        try {
            const responseOficio = await fetch(`${API}/api/presupuestos/ultimo-oficio/4`);
